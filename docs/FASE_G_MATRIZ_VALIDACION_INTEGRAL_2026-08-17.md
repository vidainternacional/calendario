...
- `líder`: **no es un rol global**; es una capacidad por ministerio derivada de `ministerio_miembros.es_lider`.
- `servidor`: usuario autenticado común; sus capacidades dependen de membresías, asignaciones y permisos adicionales.
...
Por ello, las pruebas se registrarán como **rol + capacidad efectiva + contexto**.

## Leyenda de acceso esperado

- `SÍ`: acceso esperado por rol global.
- `CTX`: depende de membresía, liderazgo, asignación o permiso explícito.
- `NO`: no debe acceder; una URL directa debe bloquear/redirigir.

## Matriz maestra

| Área / recorrido | Administrador | Pastor | Líder ministerial | Servidor | Estado FASE G | Evidencia / criterio |
|---|---:|---:|---:|---:|---|---|
...
| Ministerios / listado visible | SÍ | SÍ | CTX | CTX | PENDIENTE DE CUENTA/DATO | Admin/Pastor pueden inspeccionar; otros según membresía |
| Ministerio / acceso por URL directa | SÍ | SÍ | CTX | CTX | PENDIENTE DE CUENTA/DATO | No miembro común debe ser redirigido |
| Ministerio / personalización | SÍ | SÍ | SÍ | NO | PENDIENTE DE CUENTA/DATO | Solo admin/pastor/líder contextual |
...
| Solicitudes del ministerio | SÍ | SÍ | SÍ | CTX | PENDIENTE DE CUENTA/DATO | Solo gestor resuelve; servidor ve lo propio |
| Avisos de ministerio / lectura | SÍ | SÍ | SÍ | CTX | PENDIENTE DE CUENTA/DATO | Miembro recibe lo correspondiente |
| Avisos de ministerio / creación | SÍ | SÍ | SÍ | NO | PENDIENTE DE CUENTA/DATO | Permiso de gestión requerido |
| Aprobación de avisos | SÍ | SÍ | CTX | NO | PENDIENTE DE CUENTA/DATO | Solo responsables autorizados |
| Programación ministerial / vista mensual | SÍ | SÍ | SÍ | CTX | PENDIENTE DE CUENTA/DATO | Equipo y eventos correctos |
| Programación / asignar integrante por función | SÍ | SÍ | SÍ | NO | PENDIENTE DE CUENTA/DATO | Gestor programa; servidor no modifica equipo ajeno |
| Programación / repertorio, tonos, enlaces, colores | SÍ | SÍ | SÍ | CTX | PENDIENTE DE CUENTA/DATO | Datos persisten y llegan al evento correcto |
...
| Resolver reemplazo | SÍ | SÍ | SÍ | NO | PENDIENTE DE CUENTA/DATO | Gestor ve solo solicitudes autorizadas |
| Nuevo reemplazo / confirmación | CTX | CTX | CTX | SÍ | PENDIENTE DE CUENTA/DATO | Nuevo integrante queda pendiente y confirma |
| Historial de programación/reemplazos | SÍ | SÍ | SÍ | CTX | PENDIENTE DE CUENTA/DATO | Editar/quitar no destruye historial aprobado |
...
| Administración / usuarios | SÍ | CTX | NO | NO | PENDIENTE DE CUENTA/DATO | Acciones destructivas solo donde estén autorizadas |
| Administración / ministerios | SÍ | CTX | NO | NO | PENDIENTE DE CUENTA/DATO | Gestión global protegida |
...
3. Membresía/liderazgo contextual de Ministerios.
4. Acceso al Centro Pastoral por rol o permiso explícito.
5. URLs directas de superficies restringidas.
