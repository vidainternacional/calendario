...
function ensamblarEstudioContextual(bundle: BiblicalContextBundle): EstudioResultado {
  ...
  return {
    // Estas tres capas solo deben aparecer cuando existe evidencia textual real.
    // TextualEvidencePanel se encarga de mostrarlas; el contexto no inventa sustitutos.
    texto_original: '',
    transliteracion: '',
    traduccion_literal: '',
    ...
    // No mostramos una explicación sobre dónde comparar versiones como si fuera contenido del estudio.
