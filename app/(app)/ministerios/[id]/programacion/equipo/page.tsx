...
import { CalendarDays, ChevronLeft, Trash2, UserPlus, Users } from 'lucide-react'
import { createAdminClient, createClient } from '@/lib/supabase/server'
import { asignarServidorAlabanza, quitarServidorAlabanza } from '@/app/actions/programacion-alabanza'
...
export default async function EquipoAlabanzaPage({ params, searchParams }: { params: Promise<{ id: string }>; searchParams: Promise<{ mes?: string; evento?: string }> }) {
  ...
  if (evento) {
    const [a, c, mm] = await Promise.all([
