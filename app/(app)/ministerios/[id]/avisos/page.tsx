        ...
        {!avisos || avisos.length === 0 ? (
          ...
          <div className="overflow-hidden rounded-[24px] bg-white ring-1 ring-black/[0.045]">
            {avisos.map((aviso: any, index: number) => {
              const remitenteTipo = String(aviso.remitente_tipo || 'autor')
              const remitente = remitenteTipo === 'vida'
                ? 'VIDA Internacional'
                : remitenteTipo === 'ministerio'
                  ...
                  : remitenteTipo === 'lider'
                    ...
                    : remitenteTipo === 'personalizado'
                      ? aviso.remitente_nombre || aviso.profiles?.nombre_completo || 'Usuario'
                  ...
                  <div className="flex min-w-0 items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-3 flex flex-wrap items-center gap-x-2 gap-y-1 text-[12px] text-slate-400">
                        <span className="font-semibold text-slate-500">{remitente}</span>
