  ...
  return (
    <main className="mx-auto min-h-screen max-w-2xl bg-[#f4f5f9] px-4 pb-[calc(7rem+env(safe-area-inset-bottom))] pt-[calc(env(safe-area-inset-top)+4.75rem)] sm:px-6 sm:pt-12">
      ...
      <section className="mt-5 space-y-3">
        <Link href="/admin/ayuda-solidaria" className="flex items-center gap-3 rounded-[20px] bg-white p-4 shadow-sm ring-1 ring-black/[0.04]"><span className="flex h-10 w-10 items-center justify-center rounded-xl bg-rose-50 text-rose-600"><HeartHandshake className="h-5 w-5" /></span><div className="min-w-0 flex-1"><p className="text-sm font-bold text-[#171923]">Ayuda Solidaria</p><p className="text-[11px] text-slate-400">Gestión pastoral de necesidades y aportes</p></div><ChevronRight className="h-4 w-4 text-slate-300" /></Link>
