    ...
    <main className="min-h-screen bg-[#f5f5f7] pb-[calc(7rem+env(safe-area-inset-bottom))] pt-[env(safe-area-inset-top)]">
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-6 flex items-start gap-4">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-2 max-w-xl text-sm leading-6 text-white/72">Atiende mensajes, coordina siembras y administra la despensa sin convertir la ayuda en un trámite.</p>
            </div>
          </div>
      ...
      <div className="mx-auto max-w-3xl px-4 pt-5 sm:px-6">
        <div className="mb-5 flex items-start gap-3 rounded-[22px] bg-white p-4 ring-1 ring-black/[0.05]">
          ...
          <p className="text-xs leading-5 text-slate-600">Los mensajes, teléfonos y nombres solo están disponibles para el equipo autorizado. La despensa muestra necesidades generales; nunca identifica públicamente a quien pidió ayuda.</p>
        </div>
