          ...
          <div className="mb-5 flex min-w-0 items-start gap-4">
            ...
            <div className="min-w-0 flex-1 pt-1">
              ...
              <div className="mt-2 flex flex-wrap gap-2">
                ...
                {discipuladoAprobado === true && <Link href="/discipulado/completado" prefetch={false} aria-label="Abrir discipulado completado" className="inline-flex items-center gap-1.5 rounded-full border border-amber-200 bg-amber-50 px-2.5 py-1 text-xs font-bold text-amber-700 transition active:scale-[.98]"><Star className="h-3.5 w-3.5 fill-current" /> Discipulado completado</Link>}
              </div>
