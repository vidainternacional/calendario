...
export const ALEF_BET: readonly AlefBetLetter[] = [
  ...
  {
    orden: 2, letra: 'ב', nombre: 'Bet / Vet', transliteracion: 'b / v', unicode: 'U+05D1', valor: 2,
    sonidoPedagogico: 'בּ = B; ב sin dagesh = V.',
    pronunciacion: 'Con dagesh: B fuerte como en “burro”. Sin dagesh: V suave y labiodental como en “vaca”.',
    ...
    grupo: 'begadkefat', variantes: ['בּ Bet: B con dagesh', 'ב Vet: V sin dagesh'],
    nota: 'Primero aprende la oposición Bet/Vet: el dagesh distingue B de V en la pronunciación pedagógica del curso.',
  },
  {
  ...
  {
    orden: 6, letra: 'ו', nombre: 'Vav', transliteracion: 'v', unicode: 'U+05D5', valor: 6,
    sonidoPedagogico: 'V consonántica, labiodental.',
    pronunciacion: 'Pronúnciala V como en “vaca”. En la metodología del curso no se usa W para representar la Vav.',
    ...
    ejemplo: { palabra: 'וְ', transliteracion: 've-', significado: 'y (conjunción prefijada)' },
    variantes: ['ו consonántica = V', 'וֹ holam-vav = O', 'וּ shureq = U'],
    nota: 'También participa en la escritura de vocales: וֹ puede representar o y וּ representa u. Distingue esas funciones de la Vav consonántica.',
  },
  {
