export type SupportVerificationStatus = 'pendiente' | 'verificado' | 'corregir'
...
export type HebrewSupportClass = {
  ...
  videoId: string
  miniatura: string
  verificacion: SupportVerificationStatus
}

/**
 * Material de apoyo externo para FASE H.
 *
 * Los 11 enlaces fueron proporcionados por el usuario y se conservan exactamente
 * hasta completar corroboración visual. Las miniaturas se obtienen desde la ruta
 * pública estándar de YouTube para el videoId correspondiente y sirven únicamente
 * para revisar que cada enlace apunte a la clase esperada.
 *
...
export const HEBREW_SUPPORT_COURSE: readonly HebrewSupportClass[] = [
  {
    ...
    videoId: 'fvBD-rFlTfg',
    miniatura: 'https://i.ytimg.com/vi/fvBD-rFlTfg/hqdefault.jpg',
  ...
  },
  {
    ...
    videoId: 'SDXpqQEyJMQ',
    miniatura: 'https://i.ytimg.com/vi/SDXpqQEyJMQ/hqdefault.jpg',
    verificacion: 'pendiente',
  },
  {
    orden: 3,
    ...
    videoId: 'FQNxp1sBhW4',
    miniatura: 'https://i.ytimg.com/vi/FQNxp1sBhW4/hqdefault.jpg',
    verificacion: 'pendiente',
  },
  {
    orden: 4,
    ...
    videoId: 'ThBVM5GHgN8',
    miniatura: 'https://i.ytimg.com/vi/ThBVM5GHgN8/hqdefault.jpg',
    verificacion: 'pendiente',
  },
  {
    orden: 5,
    ...
    videoId: 'yDL7kY-x5u8',
    miniatura: 'https://i.ytimg.com/vi/yDL7kY-x5u8/hqdefault.jpg',
    verificacion: 'pendiente',
  },
  {
    orden: 6,
    ...
    videoId: 'gxRYxrGZd7s',
    miniatura: 'https://i.ytimg.com/vi/gxRYxrGZd7s/hqdefault.jpg',
    verificacion: 'pendiente',
  },
  {
    orden: 7,
    ...
    videoId: 'hqN4n6q7vU8',
    miniatura: 'https://i.ytimg.com/vi/hqN4n6q7vU8/hqdefault.jpg',
    verificacion: 'pendiente',
  },
  {
    orden: 8,
    ...
    videoId: '9sNpPXd0ZjY',
    miniatura: 'https://i.ytimg.com/vi/9sNpPXd0ZjY/hqdefault.jpg',
    verificacion: 'pendiente',
  },
  {
    orden: 9,
    ...
    videoId: 'U-pVctsaKdw',
    miniatura: 'https://i.ytimg.com/vi/U-pVctsaKdw/hqdefault.jpg',
    verificacion: 'pendiente',
  },
  {
    orden: 10,
    ...
    videoId: 'dFf_YESTZPA',
    miniatura: 'https://i.ytimg.com/vi/dFf_YESTZPA/hqdefault.jpg',
    verificacion: 'pendiente',
  },
  {
    orden: 11,
    ...
    videoId: 'UIdIzEtweOc',
    miniatura: 'https://i.ytimg.com/vi/UIdIzEtweOc/hqdefault.jpg',
    verificacion: 'pendiente',
  },
]
