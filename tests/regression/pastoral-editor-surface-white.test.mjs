...
test('superficie integrada forma parte de la autoridad estable', () => {
...
test('Editar usa el fondo integrado en zonas estructurales', () => {
  assert.match(css, /pastoral-editor-v4 > header,[\s\S]*pastoral-tool-panel[\s\S]*background: var\(--pastoral-stable-bg\) !important/)
})
