...
test('la franja de páginas sigue fija y visible sobre la misma mesa gris', () => {
  ...
  assert.match(css, /pastoral-pages-strip,[\s\S]*pastoral-tool-panel,[\s\S]*pastoral-tool-dock[\s\S]*background: var\(--pastoral-edit-desk\) !important/)
})
