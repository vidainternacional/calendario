...
test('FASE H: fichas conservan datos históricos con certeza editorial', () => {
...
test('FASE H: mini-fichas y ficha ampliada mantienen layout móvil aprobado', () => {
...
test('FASE H: fichas abren y retraen con zoom respetando reduced motion', () => {
...
test('FASE H: explicación del Alef-Bet mantiene desplegable con scroll limitado', () => {
...
test('FASE H: encabezado conserva hebreo protagonista y no reintroduce botón Lectura', () => {
...
test('FASE H: primer sector se llama Alef-Bet y no Letras', () => {
...
test('FASE H: explicaciones posteriores mantienen patrón desplegable con scroll', () => {
...
test('FASE H: Vocales abre explorador real de niqqud', () => {
