-- FASE H / Bloque 3 — lote editorial de glosas adjetivales españolas.
-- Aprobado por el usuario para aplicación controlada.
-- Política: insert-only + ON CONFLICT DO NOTHING.
-- Autoridad semántica: source_gloss inglés aprobado de STEPBible/TAHOT.
-- No usa RV1909, contexto ni inferencia desde el lema hebreo para decidir el significado.
--
-- Reversión exacta:
