-- FASE H / Bloque 3
-- Lote de 1,000 formas españolas de nombres/entidades hebreas.
-- Fuente de la forma española: RV1909, PDPT y BES ya importadas/aprobadas en VIDA.
-- La forma se toma únicamente de referencias donde ocurre la misma entrada léxica.
-- No usa el contexto como significado y no modifica léxico fuente, Strong, lema, hebreo, RLS ni grants.
