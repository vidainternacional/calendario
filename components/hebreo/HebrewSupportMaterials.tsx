...
export default function HebrewSupportMaterials() {
  return (
    <main className="min-h-screen bg-[#f9f9fb] text-slate-950">
      <div className="mx-auto w-full max-w-3xl px-4 pb-10 pt-3 sm:px-6">
        ...
        <section aria-label="Materiales del curso" className="mt-5 divide-y divide-slate-200 border-y border-slate-200 bg-white">
          {GROUPS.map(group => (
