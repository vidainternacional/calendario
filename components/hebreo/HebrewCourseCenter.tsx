      ...
      <div className="mx-auto w-full max-w-5xl px-4 pb-10 pt-3 sm:px-6">
        <header>
          ...
          <div className="mx-auto mt-1 max-w-lg text-center">
            ...
            <p className="mx-auto mt-1 max-w-sm text-[11px] leading-relaxed text-slate-500">Avanza en orden y abre únicamente lo que vas a estudiar.</p>
        ...
        {activeSection && <section aria-live="polite" className="mt-6 border-t border-slate-200 pt-5"><div className="mx-auto w-full"><SectionContent id={activeSection.id} /></div></section>}
        {!activeSection && <p className="mt-5 text-center text-[10px] leading-relaxed text-slate-400">Selecciona una etapa para comenzar.</p>}
      </div>
    </main>
  )
}
