...
type NiqqudGroup = 'aei' | 'ou' | 'sheva' | 'reduced'
...
const NIQQUD_MARKS: readonly NiqqudMark[] = [
  { id: 'patah', order: 1, name: 'Pataj', hebrewName: 'פתח', visibleSign: '◌ַ', example: 'לַ', reading: 'la', sound: 'a', family: 'A', group: 'aei', unicode: 'U+05B7', explanation: 'Una pequeña línea bajo la consonante. Para comenzar, léela como una a clara.', formula: 'ל + ◌ַ = לַ', functionLabel: 'Vocal a' },
  { id: 'qamats', order: 2, name: 'Qamats', hebrewName: 'קמץ', visibleSign: '◌ָ', example: 'לָ', reading: 'la', sound: 'a · a veces o', family: 'A', group: 'aei', unicode: 'U+05B8', explanation: 'Tiene forma de una pequeña T bajo la consonante. En la lectura pedagógica inicial normalmente se presenta como a.', caution: 'En determinados contextos aparece qamats qatan y suena o. La app lo enseña después dentro de las reglas de lectura.', formula: 'ל + ◌ָ = לָ', functionLabel: 'Vocal a / o según contexto' },
  { id: 'segol', order: 3, name: 'Segol', hebrewName: 'סגול', visibleSign: '◌ֶ', example: 'לֶ', reading: 'le', sound: 'e', family: 'E', group: 'aei', unicode: 'U+05B6', explanation: 'Tres puntos colocados como un pequeño triángulo debajo de la consonante. Para empezar, léelo como e.', formula: 'ל + ◌ֶ = לֶ', functionLabel: 'Vocal e' },
  { id: 'tsere', order: 4, name: 'Tsere', hebrewName: 'צירי', visibleSign: '◌ֵ', example: 'לֵ', reading: 'le', sound: 'e', family: 'E', group: 'aei', unicode: 'U+05B5', explanation: 'Dos puntos horizontales bajo la consonante. En la lectura pedagógica inicial se reconoce como e.', formula: 'ל + ◌ֵ = לֵ', functionLabel: 'Vocal e' },
  { id: 'hiriq', order: 5, name: 'Hiriq', hebrewName: 'חיריק', visibleSign: '◌ִ', example: 'לִ', reading: 'li', sound: 'i', family: 'I', group: 'aei', unicode: 'U+05B4', explanation: 'Un solo punto debajo de la consonante. Para comenzar, léelo como i.', formula: 'ל + ◌ִ = לִ', functionLabel: 'Vocal i' },
  { id: 'holam', order: 6, name: 'Holam', hebrewName: 'חולם', visibleSign: '◌ֹ', example: 'לֹ', reading: 'lo', sound: 'o', family: 'O', group: 'ou', unicode: 'U+05B9', explanation: 'Un punto situado arriba de la consonante. Para comenzar, léelo como o.', caution: 'También puede aparecer con vav, por ejemplo וֹ. Esa forma se verá con más detalle al leer palabras reales.', formula: 'ל + ◌ֹ = לֹ', functionLabel: 'Vocal o' },
  { id: 'qubuts', order: 7, name: 'Qubuts', hebrewName: 'קובוץ', visibleSign: '◌ֻ', example: 'לֻ', reading: 'lu', sound: 'u', family: 'U', group: 'ou', unicode: 'U+05BB', explanation: 'Tres puntos diagonales debajo de la consonante. Para comenzar, léelo como u.', formula: 'ל + ◌ֻ = לֻ', functionLabel: 'Vocal u' },
  { id: 'shuruq', order: 8, name: 'Shuruq', hebrewName: 'שורוק', visibleSign: 'וּ', example: 'לוּ', reading: 'lu', sound: 'u', family: 'U', group: 'ou', unicode: 'U+05D5 + U+05BC', explanation: 'Se escribe con Vav y un punto dentro. En esta función vocálica representa u.', caution: 'El punto U+05BC también funciona como dagesh o mapiq en otros contextos. Aquí lo estamos viendo únicamente como parte de shuruq.', formula: 'ל + וּ = לוּ', functionLabel: 'Vocal u con Vav' },
  { id: 'sheva', order: 9, name: 'Sheva', hebrewName: 'שווא', visibleSign: '◌ְ', example: 'לְ', reading: 'lə · o sin vocal', sound: 'variable', family: 'Variable', group: 'sheva', unicode: 'U+05B0', explanation: 'Dos puntos verticales bajo la consonante. Puede representar una vocal muy breve o no pronunciarse.', caution: 'No la memorices como una e fija: el curso distingue Sheva Na (vocal) y Sheva Naj (silenciosa) dentro de palabras reales.', formula: 'ל + ◌ְ = לְ', functionLabel: 'Vocal breve o silencio' },
...
const GROUPS: readonly { id: 'all' | NiqqudGroup; label: string; explanation: string }[] = [
  { id: 'aei', label: 'A · E · I', explanation: 'Primera parte del curso: Pataj, Qamats, Segol, Tsere e Hiriq. Aprende consonante + vocal antes de añadir más signos.' },
  { id: 'ou', label: 'O · U', explanation: 'Segunda parte: Holam, Qubuts y Shuruq. Aquí Vav puede participar como soporte vocálico de O o U.' },
  { id: 'sheva', label: 'Sheva', explanation: 'Después de las vocales completas: distingue Sheva Na (vocal breve) y Sheva Naj (silenciosa) dentro de palabras.' },
  { id: 'reduced', label: 'Reducidas', explanation: 'Amplía la lectura con Hataf Pataj, Hataf Segol y Hataf Qamats, frecuentes especialmente junto a guturales.' },
  { id: 'all', label: 'Todas', explanation: 'Repaso conjunto de las doce formas después de recorrer A/E/I, O/U y Sheva en ese orden.' },
]
...
function NiqqudIntroduction() {
  ...
  return (
    <section className="border-y border-slate-200 text-left">
      ...
      {open && <div className="border-t border-slate-200 p-4"><div className="max-h-72 space-y-3 overflow-y-auto overscroll-contain pr-1 text-[14px] leading-relaxed text-slate-600 [-webkit-overflow-scrolling:touch]"><p>El hebreo se lee de derecha a izquierda. El niqqud son puntos y pequeñas marcas añadidas a las consonantes para ayudar a indicar cómo se vocaliza el texto.</p><p>Sigue el orden del curso: primero A, E, I; después O, U; luego Sheva. Mira primero la consonante y enseguida el signo vocálico para formar la sílaba.</p><p>No son letras nuevas. La práctica recomendada es breve y constante: unos minutos diarios leyendo en voz alta y combinando consonante + vocal.</p></div></div>}
    </section>
  )
}
...
export default function NiqqudExplorer() {
  const [group, setGroup] = useState<'all' | NiqqudGroup>('aei')
