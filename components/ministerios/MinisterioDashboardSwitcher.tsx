  ...
  return (
    <div className="relative ml-auto shrink-0">
      <button
        ...
        className="relative grid h-12 w-12 place-items-center rounded-full border-2 border-white bg-white text-xl shadow-[0_6px_20px_rgba(20,24,40,0.22)] ring-1 ring-slate-200 transition-transform active:scale-95"
          ...
          >
            <div className="px-2 pb-3 pt-1">
              ...
              <p className="mt-1 text-xs leading-relaxed text-slate-500">
                Aquí aparecen únicamente los ministerios donde ya eres miembro.
              </p>
            </div>
            ...
            {ministerios.length > 0 ? (
              ...
              <p className="rounded-2xl bg-slate-50 px-4 py-6 text-center text-sm text-slate-500">
                Todavía no perteneces a ningún ministerio activo.
              </p>
            )}
