...
import RepertorioServicioEditor from '@/components/ministerios/RepertorioServicioEditor'

type Props = { ministerioId: string; eventoId: string; puedeEditarProgramacion: boolean; puedePaleta: boolean; asignadosEvento: any[]; repertorio: any[]; biblioteca: any[]; paleta: any; colores: string[]; defaults: string[] }
