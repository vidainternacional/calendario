...
export default function ProgramacionUXEnhancer() {
  ...
  return (
    <style jsx global>{`
      ...
      .programacion-ministerial #servicio-activo > details:nth-of-type(1) > summary {
        background: #f5f7ff;
      }

      .programacion-ministerial #servicio-activo > details:nth-of-type(2) > summary {
        background: #faf7ff;
      }

      .programacion-ministerial #servicio-activo > details:nth-of-type(3) > summary {
        background: #fff7fb;
      }
